    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(auth->auth
                        ...
                        .requestMatchers("/api/v1/project/{projStatus}/ProjectStatus").hasAnyRole(GM.name(), ADMIN.name())
                        .requestMatchers(HttpMethod.GET, "/api/v1/project/{projStatus}/ProjectStatus").hasAnyAuthority(GM_READ.name(), ADMIN_READ.name())
